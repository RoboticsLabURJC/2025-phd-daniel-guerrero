...
LOGS_DIR = os.path.abspath("/home/daniel/code/2025-phd-daniel-guerrero/scripts/dataset_generation/logs_crudos/autopilot carla") 
...
def main():
    ...
    with open(csv_path, "w", newline="") as f:
        ...
        for log_file in log_files:
            ...
            # --- NUEVA LÍNEA: Guardar posición inicial del vehículo ---
            ...
            try:
                ...
                while elapsed_time < total_duration:
                    ...
                    # --- LÍNEAS COMENTADAS PARA EJECUCIÓN HEADLESS ---
                    # Mostrar progreso visual (puedes comentarlo para más velocidad)
    ...
    # --- LÍNEA COMENTADA PARA EJECUCIÓN HEADLESS ---
