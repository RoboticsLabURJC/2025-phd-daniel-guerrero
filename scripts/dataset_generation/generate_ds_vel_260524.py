...
LOGS_DIR = os.path.abspath("/home/daniel/code/2025-phd-daniel-guerrero/scripts/dataset_generation/logs_dagger") 
...
def main():
    ...
    # Aumentamos el timeout general para darle margen a logs muy pesados y cargas de mapas
    ...
    with open(csv_path, "w", newline="") as f:
        ...
        for log_file in log_files:
            ...
            if total_duration < 1.0:
                print(f"[ADVERTENCIA] El log {log_name} dura menos de 1 segundo. Saltando para evitar errores.")
                continue

            # Breve pausa para dejar que el servidor limpie la memoria del log anterior
            time.sleep(2)
            ...
            # --- BÚSQUEDA ROBUSTA DEL VEHÍCULO EGO ---
            vehicle = None
            max_intentos = 50  # Esperar hasta 50 ticks (5 segundos en simulación) para que spawnee
            print("[INFO] Esperando a que se instancie el vehículo Ego...")
            ...
            if vehicle is None:
                print(f"[ERROR] No se encontró el vehículo 'ego' en {log_name} tras {max_intentos} ticks. Saltando...")
            ...
            try:
                while elapsed_time < total_duration:
                    ...
                    # Leer controles y velocidad
                    control = vehicle.get_control()
                    
                    current_location = vehicle.get_location()
                    distance_m = current_location.distance(previous_location)
                    speed_ms = distance_m / FIXED_DT
                ...
                # Destruir todos los actores creados por el log antes de pasar al siguiente
